...
LEXICON: dict[str, str] = {
    # pronouns
    "main": "میں", "mein": "میں", "mai": "میں", "me": "میں",
    "tum": "تم", "tu": "تو", "ap": "آپ", "aap": "آپ",
    "hum": "ہم", "hm": "ہم", "wo": "وہ", "woh": "وہ", "ye": "یہ", "yeh": "یہ",
    "mera": "میرا", "meri": "میری", "mere": "میرے",
    "tumhara": "تمہارا", "tumhari": "تمہاری",
    "apka": "آپ کا", "apki": "آپ کی", "hamara": "ہمارا", "hamari": "ہماری",
    "uska": "اس کا", "uski": "اس کی", "unka": "ان کا",
    # auxiliaries and copulas
    "hai": "ہے", "hay": "ہے", "he": "ہے", "hain": "ہیں", "hn": "ہیں",
    "ho": "ہو", "hoon": "ہوں", "hun": "ہوں", "hu": "ہوں",
    "tha": "تھا", "thi": "تھی", "thay": "تھے", "the": "تھے",
    "hoga": "ہوگا", "hogi": "ہوگی", "honge": "ہوں گے",
    "raha": "رہا", "rahi": "رہی", "rahe": "رہے",
    "gaya": "گیا", "gayi": "گئی", "gaye": "گئے",
    "diya": "دیا", "liya": "لیا", "kiya": "کیا", "kia": "کیا",
    # negation and question words
    "nahi": "نہیں", "nahin": "نہیں", "nhi": "نہیں", "naheen": "نہیں", "na": "نہ",
    "mat": "مت", "bina": "بغیر",
    "kya": "کیا", "kyun": "کیوں", "kyu": "کیوں", "kiyun": "کیوں",
    "kaise": "کیسے", "kaisa": "کیسا", "kaisi": "کیسی",
    "kahan": "کہاں", "kahaan": "کہاں", "kab": "کب", "kaun": "کون", "kon": "کون",
    "kitna": "کتنا", "kitni": "کتنی", "kitne": "کتنے",
    # postpositions and particles
    "ka": "کا", "ki": "کی", "ke": "کے", "ko": "کو", "se": "سے",
    "par": "پر", "pe": "پے", "tak": "تک", "liye": "لیے", "lye": "لیے",
    "sath": "ساتھ", "saath": "ساتھ", "bhi": "بھی", "hi": "ہی",
    "aur": "اور", "or": "اور", "ya": "یا", "agar": "اگر", "to": "تو", "tou": "تو",
    "lekin": "لیکن", "magar": "مگر", "phir": "پھر", "fir": "پھر",
    "abhi": "ابھی", "ab": "اب", "jab": "جب", "tab": "تب",
    # common verbs
    "karna": "کرنا", "karta": "کرتا", "karti": "کرتی", "karte": "کرتے",
    "kar": "کر", "karo": "کرو", "karen": "کریں",
    "hona": "ہونا", "jana": "جانا", "jata": "جاتا", "jati": "جاتی",
    "ana": "آنا", "aana": "آنا", "ata": "آتا", "aata": "آتا",
    "dena": "دینا", "lena": "لینا", "kehna": "کہنا", "kaha": "کہا",
    "dekhna": "دیکھنا", "dekha": "دیکھا", "sunna": "سننا", "suna": "سنا",
    "khana": "کھانا", "peena": "پینا", "sona": "سونا", "chalna": "چلنا",
    "milna": "ملنا", "mila": "ملا", "bolna": "بولنا", "likhna": "لکھنا",
    "parhna": "پڑھنا", "samajhna": "سمجھنا", "samajh": "سمجھ",
    "chahiye": "چاہیے", "chahta": "چاہتا", "chahti": "چاہتی",
    "sakta": "سکتا", "sakti": "سکتی", "sakte": "سکتے",
    # adjectives and adverbs
    "acha": "اچھا", "accha": "اچھا", "achi": "اچھی", "ache": "اچھے",
    "bura": "برا", "buri": "بری", "theek": "ٹھیک", "thik": "ٹھیک",
    "bohat": "بہت", "bahut": "بہت", "buhat": "بہت", "bht": "بہت",
    "thora": "تھوڑا", "thori": "تھوڑی", "zyada": "زیادہ", "ziada": "زیادہ",
    "kam": "کم", "bara": "بڑا", "bari": "بڑی", "chota": "چھوٹا", "choti": "چھوٹی",
    "naya": "نیا", "nayi": "نئی", "purana": "پرانا",
    "khush": "خوش", "udaas": "اداس", "sach": "سچ", "jhoot": "جھوٹ",
    "jaldi": "جلدی", "dheere": "دھیرے", "aaram": "آرام",
    # nouns
    "ghar": "گھر", "kaam": "کام", "kam2": "کام", "waqt": "وقت", "wqt": "وقت",
    "din": "دن", "raat": "رات", "subah": "صبح", "sham": "شام",
    "aaj": "آج", "aj": "آج", "kal": "کل", "parso": "پرسوں", "saal": "سال",
    "mahina": "مہینہ", "hafta": "ہفتہ",
    "pani": "پانی", "paani": "پانی", "roti": "روٹی", "chai": "چائے",
    "paisa": "پیسہ", "paise": "پیسے", "rupay": "روپے",
    "dost": "دوست", "bhai": "بھائی", "behen": "بہن", "ammi": "امی", "abbu": "ابو",
    "walid": "والد", "walida": "والدہ", "beta": "بیٹا", "beti": "بیٹی",
    "dil": "دل", "jaan": "جان", "pyar": "پیار", "muhabbat": "محبت",
    "zindagi": "زندگی", "khushi": "خوشی", "gham": "غم",
    "kitab": "کتاب", "school": "اسکول", "university": "یونیورسٹی",
    "sarak": "سڑک", "gari": "گاڑی", "shehar": "شہر", "gaon": "گاؤں",
    "mulk": "ملک", "duniya": "دنیا", "log": "لوگ", "admi": "آدمی", "aurat": "عورت",
    # greetings and fixed phrases
    "salam": "سلام", "assalam": "السلام", "walaikum": "وعلیکم",
    "shukriya": "شکریہ", "meherbani": "مہربانی", "khuda": "خدا", "allah": "اللہ",
    "inshallah": "ان شاء اللہ", "mashallah": "ماشاء اللہ",
    "hafiz": "حافظ", "khudahafiz": "خدا حافظ",
    "mubarak": "مبارک", "maaf": "معاف", "sorry": "معذرت",
    # place names
    "pakistan": "پاکستان", "lahore": "لاہور", "karachi": "کراچی",
    "islamabad": "اسلام آباد", "peshawar": "پشاور", "quetta": "کوئٹہ",
    "multan": "ملتان", "faisalabad": "فیصل آباد", "punjab": "پنجاب",
    "sindh": "سندھ", "urdu": "اردو",
}
...
RULES: list[tuple[str, str]] = [
    ...
    ("bh", "بھ"), ("ph", "پھ"), ("th", "تھ"), ("jh", "جھ"), ("chh", "چھ"),
    ("dh", "دھ"), ("rh", "رھ"), ("kh", "کھ"), ("gh", "گھ"), ("lh", "لھ"),
    ("mh", "مھ"), ("nh", "نھ"),
    # digraph consonants
    ("ch", "چ"), ("sh", "ش"), ("zh", "ژ"), ("ng", "نگ"), ("ny", "نی"),
    # long vowels before short ones
    ("aa", "ا"), ("ee", "ی"), ("ii", "ی"), ("oo", "و"), ("uu", "و"),
    ("ai", "ے"), ("ay", "ے"), ("ei", "ی"), ("au", "و"), ("ou", "و"),
    # single consonants
    ("b", "ب"), ("p", "پ"), ("t", "ت"), ("j", "ج"), ("d", "د"), ("r", "ر"),
    ("z", "ز"), ("s", "س"), ("f", "ف"), ("q", "ق"), ("k", "ک"), ("g", "گ"),
    ("l", "ل"), ("m", "م"), ("n", "ن"), ("v", "و"), ("w", "و"), ("h", "ہ"),
    ("y", "ی"), ("c", "ک"), ("x", "کس"),
    # short vowels
    ("a", "ا"), ("e", "ے"), ("i", "ی"), ("o", "و"), ("u", "و"),
]
